...
import os
variable_words = [name.replace('.mp3', '') for name in os.listdir('C:\\Users\\Prometheys\\Desktop\\Python\\Sounds\\')]
correctguess = 0
incorrectguess = 0
mistakes = []
guess = ''
...
if choose == 1:
    for i in variable_words:
        playsound('C:\\Users\\Prometheys\\Desktop\\Python\\Sounds\\'+ i + '.mp3')
    ...
    while guess != 'Exit':
        ...
        playsound('C:\\Users\\Prometheys\\Desktop\\Python\\Sounds\\'+ variable_words[word_random] + '.mp3')
        guess = input('Enter your guess or enter "exit" to stop').title()
